...
<h3>Сортировки</h3>
<table>
<tr><th>Алгоритм</th><th>Средняя</th><th>Худшая</th><th>Стабильна</th></tr>
<tr><td>Пузырьковая</td><td>O(n²)</td><td>O(n²)</td><td>да</td></tr>
<tr><td>Выбором</td><td>O(n²)</td><td>O(n²)</td><td>нет</td></tr>
<tr><td>Вставками</td><td>O(n²)</td><td>O(n²)</td><td>да</td></tr>
<tr><td><b>Быстрая (Quick)</b></td><td>O(n log n)</td><td>O(n²)</td><td>нет</td></tr>
<tr><td><b>Слиянием (Merge)</b></td><td>O(n log n)</td><td>O(n log n)</td><td>да</td></tr>
<tr><td>Пирамидальная (Heap)</td><td>O(n log n)</td><td>O(n log n)</td><td>нет</td></tr>
</table>
<div class="warn-box">Частый вопрос: у QuickSort в среднем O(n log n), но <b>в худшем случае O(n²)</b>. Гарантированное O(n log n) и стабильность — только у сортировки слиянием.</div>
<p><b>Пузырьковая</b> сравнивает соседние элементы и «всплывает» большие к концу.</p>
